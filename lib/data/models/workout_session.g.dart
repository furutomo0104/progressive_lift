...
extension WorkoutSessionQuerySortBy
  ...
  QueryBuilder<WorkoutSession, WorkoutSession, QAfterSortBy> sortByMemo() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'memo', Sort.asc);
    });
  }

  QueryBuilder<WorkoutSession, WorkoutSession, QAfterSortBy> sortByMemoDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension WorkoutSessionQuerySortThenBy
  ...
  QueryBuilder<WorkoutSession, WorkoutSession, QAfterSortBy> thenByMemo() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'memo', Sort.asc);
    });
  }

  QueryBuilder<WorkoutSession, WorkoutSession, QAfterSortBy> thenByMemoDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'memo', Sort.desc);
    });
  }
...
extension WorkoutSessionQueryWhereDistinct
  ...
  QueryBuilder<WorkoutSession, WorkoutSession, QDistinct> distinctByMemo(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension WorkoutSessionQueryProperty
  ...
  QueryBuilder<WorkoutSession, String?, QQueryOperations> memoProperty() {
    return QueryBuilder.apply(this, (query) {
